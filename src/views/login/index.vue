  ...
  <div class="login">
    <div class="login-con">
      ...
      <el-form ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" class="demo-ruleForm">
        ...
        <el-form-item>
          <el-button :disabled="btnbool" type="primary" class="login-btn block" @click="submitForm(ruleFormRef)">{{ model
...
import * as ck from "../../utils/verfifcation";
